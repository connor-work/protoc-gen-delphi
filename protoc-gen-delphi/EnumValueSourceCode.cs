...
namespace Work.Connor.Protobuf.Delphi.ProtocGenDelphi
{
    ...
    internal class EnumValueSourceCode
    {
        ...
        /// </summary>
        private IdentifierGenerator<EnumValueDescriptorProto> EnumValueIdentifier => new IdentifierTemplate<EnumValueDescriptorProto>(x => x.Name, "_ProtobufEnumValue", IdentifierCase.Pascal, prefix ?? "", caseSensitive: false);
