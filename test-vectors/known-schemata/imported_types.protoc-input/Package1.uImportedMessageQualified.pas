/// <remarks>
/// This unit corresponds to the protobuf schema definition (.proto file) <c>package1/imported_message_qualified.proto</c>.
/// </remarks>
unit Package1.uImportedMessageQualified;
