...
namespace Work.Connor.Protobuf.Delphi.ProtocGenDelphi.RuntimeTests
{
    ...
    public class ProtocOperation
    {
        ...
        public class PlugInOperation
        {
            ...
            /// If this value is absent, the executable is located by <c>protoc</c> (using working directory and <c>PATH</c>).
            /// </summary>
            ...
            public PlugInOperation(string name) => this.Name = name;
            ...
            internal IEnumerable<string> ProtocArgs
            {
                get
                {
                    ...
                    if (ExecutablePath != null) yield return $"--plugin=protoc-gen-{Name}={Path.GetFullPath(ExecutablePath)}";
