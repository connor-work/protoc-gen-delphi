...
namespace Work.Connor.Protobuf.Delphi.ProtocGenDelphi.RuntimeTests
{
    ...
    public class ProtocOperation
    {
        ...
        /// If both this value and <see cref="ProtocExecutableFolder"/> are absent, the executable is located by the system (usually using working directory and <c>PATH</c>).
        /// </summary>
        public string? ProtocExecutablePath { get; set; }

        /// <summary>
        /// Optional location of the folder containing the <c>protoc</c> executable.
        /// Ignored if <see cref="ProtocExecutablePath"/> is present.
        /// If both this value and <see cref="ProtocExecutablePath"/> are absent, the executable is located by the system (usually using working directory and <c>PATH</c>).
        /// </summary>
        public string? ProtocExecutableFolder { get; set; } = null;
        ...
        /// </summary>
        private string? ActualProtocExecutablePath => ProtocExecutablePath ?? (ProtocExecutableFolder == null ? null
                                                                                                              : Path.Join(ProtocExecutableFolder, GetExecutableName($"protoc")));
