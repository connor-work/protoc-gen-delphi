...
/// </summary>
unit Work.Connor.Protobuf.Delphi.ProtocGenDelphi.StubRuntime.uProtobufRepeatedMessageField;
...
uses
  ...
  // Super class of TProtobufRepeatedMessageField
...
type
  ...
  TProtobufRepeatedMessageField<T> = class(TProtobufRepeatedField<T>)
  private
    FStorage: TList<T>;
