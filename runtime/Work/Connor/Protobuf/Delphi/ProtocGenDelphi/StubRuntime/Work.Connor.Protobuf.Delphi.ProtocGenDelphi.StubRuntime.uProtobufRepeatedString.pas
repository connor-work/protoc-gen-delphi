...
/// </summary>
unit Work.Connor.Protobuf.Delphi.ProtocGenDelphi.StubRuntime.uProtobufRepeatedString;
...
type
  ...
  /// </summary>
  TProtobufRepeatedStringField = class(TProtobufRepeatedField<UnicodeString>)
  end;
