/// <remarks>
/// This unit corresponds to the protobuf schema definition (.proto file) <c>enum_field.proto</c>.
/// </remarks>
unit uEnumField;
...
type
  ...
  /// </remarks>
  protected function GetFieldX: TEnumX; virtual;
  ...
  /// May be overridden. Overriders shall only add side-effects and must call the ancestor implementation.
  /// </remarks>
  protected procedure SetFieldX(aValue: TEnumX); virtual;
...
begin
  inherited;
  EncodeField<TProtobufEnumFieldValue>(FFieldX, PROTOBUF_FIELD_NUMBER_FIELD_X, gProtobufWireCodecEnum, aDest);
end;

procedure TMessageX.Decode(aSource: TStream);
begin
  inherited;
  FFieldX := DecodeUnknownField<TProtobufEnumFieldValue>(PROTOBUF_FIELD_NUMBER_FIELD_X, gProtobufWireCodecEnum);
end;
