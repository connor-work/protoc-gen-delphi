...
begin
  inherited;
  gProtobufWireCodecEnum.EncodeSingularField(FFieldX, self, PROTOBUF_FIELD_NUMBER_FIELD_X, aDest);
end;
...
begin
  if (aSource.FieldX <> PROTOBUF_DEFAULT_VALUE_ENUM) then FieldX := aSource.FieldX;
end;
