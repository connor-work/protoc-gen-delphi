...
uses
  ...
  Work.Connor.Protobuf.Delphi.ProtocGenDelphi.StubRuntime.uProtobufRepeatedMessage;
...
type
  ...
  /// </summary>
  private var FFieldX: TProtobufRepeatedMessageField<TMessageX>;
  ...
  /// </remarks>
  protected function GetFieldX: TProtobufRepeatedField<TMessageX>; virtual;

  /// <remarks>
  /// This property corresponds to the protobuf field <c>fieldX</c>.
  /// </remarks>
  public property FieldX: TProtobufRepeatedField<TMessageX> read GetFieldX;
...
begin
  inherited;
  FFieldX := TProtobufRepeatedMessageField<TMessageX>.Create;
  ClearOwnFields;
end;
...
begin
  inherited;
  EncodeRepeatedMessageField<TMessageX>(FFieldX, PROTOBUF_FIELD_NUMBER_FIELD_X, aDest);
end;
...
begin
  inherited;
  FFieldX.Clear;
  DecodeUnknownRepeatedMessageField<TMessageX>(PROTOBUF_FIELD_NUMBER_FIELD_X, FFieldX);
end;
...
function TMessageY.GetFieldX: TProtobufRepeatedField<TMessageX>;
begin
  result := FFieldX;
end;
